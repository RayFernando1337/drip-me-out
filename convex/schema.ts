...
export default defineSchema({
  images: defineTable({
    body: v.id("_storage"), // Storage ID reference
    createdAt: v.number(),
    isGenerated: v.optional(v.boolean()),
    originalImageId: v.optional(v.id("images")), // Proper ID reference
    ...
    .index("by_original_image_id", ["originalImageId"]), // Index for finding generated images by original
});
