...
type PublicGalleryResult = NonNullable<ReturnType<typeof useQuery<typeof api.images.getPublicGallery>>>;
    ...
    <div className="space-y-8">
      ...
      {galleryResult?.continueCursor && !galleryResult.isDone && (
        <div className="flex items-center justify-center py-8">
          <Button
            onClick={() =>
              setPaginationOpts((prev) => ({ numItems: 16, cursor: galleryResult.continueCursor }))
            }
            variant="ghost"
